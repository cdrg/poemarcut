...
Instead, PoEMarcut does the math for you in quickly adjusting item prices downward. Hover over an item, press F2+F3 to reduce its price by a the % you set. Repeat on the next item. Do it every time you log on until items sell or they reach nothing and you vendor them.
